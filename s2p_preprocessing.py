...
def default_ops():
    ...
    ops = {
        ...
        'threshold_scaling': .5, #default was 5 and never found cells, 1 worked pretty well, .5 maybe a bit too permissive but works,  # adjust the automatically determined threshold by this scalar multiplier
